...
def generate_position_examples():
    ...
    examples = [
        ...
        {
            "name": "italian_game_symbol",
            "fen": "r1bqkbnr/pppp1ppp/2n5/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 3 3",
            "size": 400,
            "theme_name": "symbol",
            "show_coordinates": True,
            "description": "Italian Game (Symbol theme)"
        }
    ]
...
- `theme_maestro.png` - Starting position with Maestro theme
- `theme_symbol.png` - Starting position with Symbol theme (lichess-style)
